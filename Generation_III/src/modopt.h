...
//#define ROLE_SAMPLE_BIT		((uchar)0x04)		//00000100
//#define ROLE_RECEIVE_BIT	((uchar)0x02)			//00000010
//#define ROLE_SEND_BIT		((uchar)0x01)			//00000001
...
#define OPTPAIR_SD_BD_IS_ATTCHD					((uint)((1<<3)+ 2))
#define OPTPAIR_CHK_FOR_SD_ON_STUP				((uint)((1<<3)+ 3))
