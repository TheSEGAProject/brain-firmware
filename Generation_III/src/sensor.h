...
**---------------------------------------------------------------------------*/
	...
	#define SENSOR_SD_MSG_VERSION		4
	...
	#define SENSOR_BR_BOARD_MSG			22 //16 Bit Follower = Sub-msg number
		...
		//#define RESTART_OF_SYS_GENERIC			20
		//#define RESTART_BY_LOW_BATTERY			21
		//#define RESTART_BY_OPERATOR				22
		//#define TIME_CHANGED_BY_RADIO				23
		//#define TIME_CHANGED_BY OPERATOR			24
		//#define ID_CHANGED_BY_OPERATOR			25
		//#define ROLE_CHANGED_BY_OPERATOR			26
		//#define UPLOAD_PERFORMED					27
		//#define DELETE_OF_FLASH_PERFORMED			28
		//#define WINDBACK_OF_FLASH_PERFORMED		29
		//#define ZERO_OF_FLASH_PERFORMED			30
		//#define ACTION_ADDED						31
		//#define ACTION_DELETED					32
		//#define ACTION_INTERVAL_MODIFIED			33
		//#define ACTION_ACT_CHANGED				34
		//#define ACTION_TRIGGERI_CHANGED			35
